...
export const ChallengeFormCard: React.FC<ChallengeFormCardProps> = ({
    ...
    const {
        teacherMenuQuery, setTeacherMenuQuery,
        exerciseSource, setExerciseSource,
        teacherExerciseQuery, setTeacherExerciseQuery,
        sortedTeacherMenus, sortedTeacherExercises,
        filteredTeacherExercises, filteredTeacherMenus,
        selectedTeacherExercise, selectedTeacherMenu, selectedPresetMenu,
        dateError, publishDateError, todayKey,
        canStartPreviewToday, isShowingPreviewBeforeStart,
        isDurationChallenge, hasError,
        selectedExercisePreview, selectedMenuPreview,
        isCustomDuration, durationSummary,
    } = form;
