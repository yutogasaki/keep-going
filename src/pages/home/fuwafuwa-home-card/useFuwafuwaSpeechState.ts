...
interface UseFuwafuwaSpeechStateArgs {
...
export function useFuwafuwaSpeechState({
    isTogetherMode,
    perUserMagic,
    displaySeconds,
    targetSeconds,
    ...
    const buildDailyContext = useMemo(
        ...
        [
            ambientCue,
            buildFamilyDailyCandidate,
            buildUserDailyCandidate,
            displaySeconds,
            isTogetherMode,
            selectedUser,
            selectedUserDisplaySeconds,
