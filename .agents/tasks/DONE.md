...
## 2026-04-25: 5月季節ふわふわ追加
- `こいのぼりふわ` と `GWふわ` を stage 1〜3 の WebP アセットとして追加し、type `12/13` を5月の季節候補にした
- 4月と同じ50%バイアスの季節抽選に整理し、開発者モード・同期・DB制約・PWA precache で type `12/13` が詰まらないことを確認した
- 通常ふわふわを3種（type `14/15/16`）追加し、通常抽選・開発者モード・PWA precache の対象に含めた
