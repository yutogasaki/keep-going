...
| P0 | StretchSession timing / background resume QA | overlay session の回帰を防ぐ | helper 分割後の pause / break / 復帰を実機で通す |
...
| P2 | オンボーディング内アカウント作成の正式実装 | 初回離脱を減らす | restore / login error 導線を settings と揃える |
