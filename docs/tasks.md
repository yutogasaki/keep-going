...
| P1 | 巨大ファイル分割 | 修正精度と開発速度を上げる | `HomeScreen / FuwafuwaHomeCard / ChallengeFormCard / migrateHelpers / fuwafuwaHomeCardCopy` から責務を切って進める |
...
- 新しいルールを増やすより、`governance:check` と CI で既存ルールを守りやすくすることを優先する
